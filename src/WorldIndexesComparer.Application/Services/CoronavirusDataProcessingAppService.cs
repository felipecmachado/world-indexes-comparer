...
namespace WorldIndexesComparer.Application.Services
{
    public class CoronavirusDataProcessingAppService : ICoronavirusDataProcessingAppService
    {
        ...
        public CoronavirusDataProcessingAppService(
            ILogger<CoronavirusDataProcessingAppService> logger,
        ...
        public async Task RefreshDataAsync(CancellationToken stoppingToken)
        {
